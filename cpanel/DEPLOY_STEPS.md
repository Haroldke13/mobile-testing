# Deploying mobile-testing to cPanel

Target: **https://mobile-testing.harold-datascience.co.ke**
...
- Domain: `mobile-testing.harold-datascience.co.ke`
- Document Root: `apps/mobile-testing/public`   ← **not** `apps/mobile-testing`
...
Zip this folder, upload through File Manager to `apps/mobile-testing`, extract there.
...
|---|---|
| Python version | 3.11 |
| Application root | `apps/mobile-testing` |
| Application URL | `mobile-testing.harold-datascience.co.ke` |
...
```
https://mobile-testing.harold-datascience.co.ke/?cb=1                    -> 200
https://mobile-testing.harold-datascience.co.ke/healthz?cb=1             -> 200
https://mobile-testing.harold-datascience.co.ke/passenger_wsgi.py?cb=1   -> must 404
```
...
Passenger writes the traceback to `~/apps/mobile-testing/stderr.log`. Read it first;
