...
Subdomain   : https://mobile-testing.harold-datascience.co.ke
App root    : apps/mobile-testing
Document root: apps/mobile-testing/public      <- separate, holds no source
Target      : Python 3.11
Resolution  : create_app() factory
...
os.environ.setdefault("SITE_DOMAIN", "mobile-testing.harold-datascience.co.ke")
os.environ.setdefault("SITE_SCHEME", "https")
os.environ.setdefault("SITE_NAME", "Mobile Testing")
...
application = _module.create_app()
